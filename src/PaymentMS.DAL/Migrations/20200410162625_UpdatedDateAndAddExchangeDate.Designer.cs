...
namespace PaymentMS.DAL.Migrations
{
    ...
    [Migration("20200410162625_UpdatedDateAndAddExchangeDate")]
    partial class UpdatedDateAndAddExchangeDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentMS.DAL.Entities.CurrencyExchangeRateEntity", b =>
                {
                    ...
                    b.HasKey("FromCurrencyCode", "ToCurrencyCode", "ExchangeDate");
            ...
            modelBuilder.Entity("PaymentMS.DAL.Entities.CurrencyExchangeRateEntity", b =>
                {
                    b.HasOne("PaymentMS.DAL.Entities.CurrencyEntity", "FromCurrency")
                        .WithMany()
                        .HasForeignKey("FromCurrencyCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PaymentMS.DAL.Entities.CurrencyEntity", "ToCurrency")
                        .WithMany()
